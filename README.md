...
. در مورد Lazy Class:  
   ...
   - زمان نادیده گرفتن: اگر کلاس مورد نظر ممکن است در آینده نقش مهم‌تری پیدا کند یا قرار است قابلیت‌های بیشتری به آن افزوده شود، می‌توان موقتاً این بو را نادیده گرفت تا کلاس به مرور از حالت تنبلی خارج شود.
...
**سوال ۵:**
پلاگین formatter برای مَیوِن (maven) ابزاری است که به‌طور خودکار قالب‌بندی و فرمت کد را بر اساس قوانینی از پیش تعریف‌شده اعمال می‌کند. این پلاگین با استفاده از تنظیمات مشخص، کد شما را یکدست و خوانا می‌کند و باعث می‌شود همهٔ هم‌تیمی‌ها با یک استاندارد یکسان از کدنویسی کار کنند.
